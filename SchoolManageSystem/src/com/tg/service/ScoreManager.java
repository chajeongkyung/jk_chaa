...
//	총점을 구하는 서비스
	public void studentInfo(StudentVo studentVo) {
		...
		studentInfoStr += studentVo.getKoreaL().getName() + "점수: " + studentVo.getKoreaL().getScore() + "\n";
		studentInfoStr += studentVo.getEnglishL().getName() + "점수: " + studentVo.getEnglishL().getScore() + "\n";
		studentInfoStr += studentVo.getMath().getName() + "점수: " + studentVo.getMath().getScore() + "\n";
