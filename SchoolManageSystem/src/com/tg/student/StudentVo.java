...
//	총점
	...
	public StudentVo(int no, String name, KoreaL koreaL, EnglishL englishL) {
	super();
	this.no = no;
	this.name = name;
	this.koreaL = koreaL;
	...
	public StudentVo(int no, String name, KoreaL koreaL, EnglishL englishL, MathL math) {
		super();
		this.no = no;
		this.name = name;
		this.koreaL = koreaL;
	...
	public String toString() {
		return "StudentVo [no=" + no + ", name=" + name + ", koreaL=" + koreaL + ", englishL=" + englishL + ", math="
				+ math + "]";
	}
