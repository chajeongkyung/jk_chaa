...
<script type="text/javascript">
	...
	function addTest() {
		  var selectBox = document.getElementById("selList");
		  var selectOptions = document.createElement("option");
		  
		  selectOptions.text = "차정경";
// 		    제일 마지막에 들어감
// 		  selectBox.options.add(selectOptions);	
		  selectBox.options.add(selectOptions, selectOptions.length);		
	}
