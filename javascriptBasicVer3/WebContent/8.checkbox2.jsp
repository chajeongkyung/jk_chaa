...
<body>
   <form>
      <table>
         ...
         <tr>
            <td><input type="checkbox" onclick="allSel(this.checked);">
              	 전체선택<br> <!-- this는 자신의 값을 반환 -->
              	 <input type="checkbox" name="rain" value="">비오는 날의 수채화<br>
         ...
         <tr>
            <td><input type="button" value="노래목록!!" onclick="likeSong();">
            </td>
         </tr>
      </table>
   </form>
